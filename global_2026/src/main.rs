...
fn main() {
    App::new()
        ...
        .add_systems(FixedUpdate, (map::map_fixed_update,bomb::bomb_fixed_update, player::player_fixed_update, player::player_animation, mask::spawn_masks, blast::blast_collision_system, stunned::stun_update).chain())
        .run();
}
